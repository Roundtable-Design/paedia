...
class _LoginWidgetState extends State<LoginWidget>
  ...
  Widget build(BuildContext context) {
    ...
    const headerOffset = 170.0;
    const outerCardPadding = 24.0;
    final maxCardHeight = screenHeight - safeVerticalPadding - headerOffset - outerCardPadding;
    final cardHeight = min(
      MediaQuery.sizeOf(context).width >= 768.0 ? 600.0 : 630.0,
      maxCardHeight,
    ).clamp(400.0, 630.0);
